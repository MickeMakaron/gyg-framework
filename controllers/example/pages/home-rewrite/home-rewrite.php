...
"
	...
	<a href = '". BASE_URL . "mars'>Go to mars.</a><p>Note that the link will only work if the gyg variable 'useRewriteRule' is set to true and a RewriteRule has been set up properly. To see an example of how to properly set up a RewriteRule, see gyg's config file.</p>
";
